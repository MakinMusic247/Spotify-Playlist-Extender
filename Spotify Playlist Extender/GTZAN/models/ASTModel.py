...
class ASTModel(nn.Module):
    ...
    def __init__(
        ...
        # print(os.path.exists("./../pretrained_models/audioset_10_10_0.4593.pth"))
        ...
        # now load a model that is pretrained on both ImageNet and AudioSet
            ...
            if (
                ...
                wget.download(
                    audioset_mdl_url,
                    out="./pretrained_models/audioset_10_10_0.4593.pth" #"../../pretrained_models/audioset_10_10_0.4593.pth",
                )
            sd = torch.load(
